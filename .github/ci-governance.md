...
| 버전 일관성    | manifest ↔ registry ↔ **multikit.toml** ↔ README, SemVer 유효성        | versioning-governance.md |
| toml 파일 추적 | multikit.toml `files` 목록 ↔ .github/ 디스크 실재 파일 ↔ manifest 선언 | ci-governance.md §7      |
...
| Version | Date       | Change                                                                                                                |
| ------- | ---------- | --------------------------------------------------------------------------------------------------------------------- |
| 1.1.0   | 2026-03-03 | 버전 일관성 검사에 multikit.toml 추가, toml 파일 추적 일관성 검사 항목 신설 (§7)                                      |
