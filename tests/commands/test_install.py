...
class TestInstallCommandFresh:
    ...
    @pytest.mark.asyncio
    async def test_install_fresh(self, initialized_project: Path, monkeypatch) -> None:
...
class TestInstallCommandErrors:
    ...
    @pytest.mark.asyncio
    async def test_install_kit_not_found(
        ...
        with m:
            ...
            with pytest.raises(SystemExit) as exc_info:
                await install_handler("nonexistent")
            assert exc_info.value.code == 1

    @pytest.mark.asyncio
    async def test_install_network_error(
        self, initialized_project: Path, monkeypatch
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_install_file_download_failure(
        self, initialized_project: Path, monkeypatch
    ) -> None:
...
class TestInstallCommandForce:
    ...
    @pytest.mark.asyncio
    async def test_install_force_overwrites(
        self, initialized_project: Path, monkeypatch
    ) -> None:
        ...
        with m:
            ...
            await install_handler("testkit", force=True)
...
class TestInstallCommandConflicts:
    ...
    @pytest.mark.asyncio
    async def test_install_conflict_yes(
        self, initialized_project: Path, monkeypatch
    ) -> None:
        ...
        with m:
            ...
            monkeypatch.setattr(
                "multikit.commands.install.prompt_overwrite", lambda _: "y"
            )
            await install_handler("testkit")
    ...
    @pytest.mark.asyncio
    async def test_install_conflict_no(
        self, initialized_project: Path, monkeypatch
    ) -> None:
        ...
        with m:
            ...
            monkeypatch.setattr(
                "multikit.commands.install.prompt_overwrite", lambda _: "n"
            )
            await install_handler("testkit")
    ...
    @pytest.mark.asyncio
    async def test_install_conflict_all(
        self, initialized_project: Path, monkeypatch
    ) -> None:
        ...
        with m:
            ...
            monkeypatch.setattr(
                "multikit.commands.install.prompt_overwrite", lambda _: "a"
            )
            await install_handler("testkit")
    ...
    @pytest.mark.asyncio
    async def test_install_conflict_skip_all(
        self, initialized_project: Path, monkeypatch
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_install_unchanged_local(
        self, initialized_project: Path, monkeypatch
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_install_config_corrupted(
        self, initialized_project: Path, monkeypatch
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_install_http_500(
        self, initialized_project: Path, monkeypatch
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_install_empty_kit_warning(
    ...
    @pytest.mark.asyncio
    async def test_install_file_http_500(
        self, initialized_project: Path, monkeypatch
    ) -> None:
    ...
    @pytest.mark.asyncio
    async def test_install_custom_registry(
        self, initialized_project: Path, monkeypatch
    ) -> None:
        ...
        with m:
            ...
            await install_handler("testkit", registry=custom_url)

            config = load_config(initialized_project)
            assert config.is_installed("testkit")

    @pytest.mark.asyncio
    async def test_install_handles_internal_staging_exception(
        self, initialized_project: Path, monkeypatch
    ) -> None:
...
class TestInstallCommandInteractive:
    ...
    @pytest.mark.asyncio
    async def test_install_interactive_registry_fetch_failure(
        self, initialized_project: Path, monkeypatch
    ) -> None:
        """Interactive install exits when registry cannot be fetched."""
        monkeypatch.chdir(initialized_project)

        async def _raise_registry(_url: str):
    ...
    @pytest.mark.asyncio
    async def test_install_interactive_no_selection_exits_zero(
        self, initialized_project: Path, monkeypatch
    ) -> None:
        ...
        async def fake_fetch_registry(_url):
            return Registry(kits=[])

        monkeypatch.setattr(
            "multikit.commands.install.fetch_registry", fake_fetch_registry
        )
        monkeypatch.setattr(
    ...
    @pytest.mark.asyncio
    async def test_install_interactive_partial_failure_exits_one(
        self, initialized_project: Path, monkeypatch
    ) -> None:
        ...
        async def _fake_install(name: str, *_args, **_kwargs) -> bool:
            return name != "bad-kit"
